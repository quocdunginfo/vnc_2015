...
class QdT_PageT_ProductDetail_ViewMobile extends QdT_Layout_Root_ViewMobile
{
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul id="bxsliderProductDetail">
                        <li><img class="img-responsive chitiet-img" src="img/panner1.jpg"/></li>
                        <li><img class="img-responsive chitiet-img" src="img/panner2.jpg"/></li>
                        <li><img class="img-responsive chitiet-img" src="img/panner3.jpg"/></li>
                        <li><img class="img-responsive chitiet-img" src="img/panner1.jpg"/></li>
                        <li><img class="img-responsive chitiet-img" src="img/panner2.jpg"/></li>
                    </ul>

                    <div style="margin: 0px -2px;" id="bx-pager">
                        <a class="col-xs-3 chitiet-thum" data-slide-index="0" href=""><img src="img/panner1.jpg"/></a>
                        <a class="col-xs-3 chitiet-thum" data-slide-index="1" href=""><img src="img/panner2.jpg"/></a>
                        <a class="col-xs-3 chitiet-thum" data-slide-index="2" href=""><img src="img/panner3.jpg"/></a>
                        <a class="col-xs-3 chitiet-thum" data-slide-index="3" href=""><img src="img/panner1.jpg"/></a>
                        <a class="col-xs-3 chitiet-thum" data-slide-index="4" href=""><img src="img/panner2.jpg"/></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row product">
                ...
                <div class="col-xs-12" style="text-align: center;">
                    <a href="dathang.html" class="btn btn-primary order-online-button">ĐẶT HÀNG ONLINE</a>
                </div>
                <div class="col-xs-12" style="text-align: center;">
            ...
            <div class="row slider-most">
                ...
                <div class="col-xs-12" style="padding-left: 8px;padding-right: 8px;">
                    <div id="bxsliderRelatedProducts">
                        ...
                        <div class="slide">
                            <div class="col-xs-12 slider-most-edit johnchuong">
                                <div class="bs-pro" style="background: url('img/panner2.jpg');
                                                          background-repeat: no-repeat;
                                                          background-size: contain;
                                                          background-position: center;">
                                </div>
                        ...
                        <div class="slide">
                            <div class="col-xs-12 slider-most-edit johnchuong">
                                <div class="bs-pro" style="background: url('img/panner3.jpg');
                                                          background-repeat: no-repeat;
                                                          background-size: contain;
                                                          background-position: center;">
                                </div>
    ...
    protected function getContentPart_bk()
    {
        ?>
        <!-- Big Sale -->
        <!-- bread crumb -->
                ...
                <div class="col-xs-12">
                    ...
                    <div class="tab-content">
                        <div id="mo-ta" class="tab-pane fade in active product-list2  edit-font-size"
                            ...
                            <div class="tinh-trang"><span style="color:black;">Tình trạng:</span> <span>Like new</span>
                            </div>
                            <div class="bao-hanh"><span style="color:black;">Bảo hành: </span> <span>6 Tháng</span>
                            </div>
                            <div class="giao-hang"><span style="color:black;">Giao hàng: </span> <span>Miễn phí</span>
                            </div>
                            <div class="phu-kien"><span style="color:black;">Phụ kiện: </span> <span>Sạc, cáp, tai nghe, que sim</span>
                            </div>
                            <div class="dac-diem"><span style="color:black;">Đặc điểm: </span>

                                <p>Vestibulum nec erat eu nulla rhoncus fringilla ut non neque. Vivamus nibh urna,
                                    ornare id gravida ut, mollis a magna. Aliquam porttitor condimentum nisi, eu viverra
                                    ipsum porta ut. Nam hendrerit bibendum turpis, sed molestie mi fermentum id.</p>
                            </div>
                        </div>
                        <div id="bao-hanh" class="tab-pane fade product-list2  edit-font-size">
                            <h3>Section B</h3>
        ...
        <script>
            ...
            $("#bx-pager img").load("", function () {
                $("#bx-pager img").height($("#bx-pager img").width() * 2 / 3);
                $("#chitiet-img").height($("#chitiet-img").width() * 2 / 3);
            });
            $("#johnchuong div").load("", function () {
                $(".bx-viewport").css("height", "auto");
                $("#johnchuong div").height($("#johnchuong div").width() * 2 / 3);
            });
        </script>
            ...
            <div class="slider4">
                ...
                foreach ($this->page->r_products as $item):
                    ...
                    <div class="slide">
                        ...
                        <div class="col-xs-12 slider-most-edit" id="johnchuong">
                            <div class="bs-pro" style="background: url('img/panner1.jpg');
                                                          background-repeat: no-repeat;
                                                          background-size: contain;
                                                          background-position: center;">
